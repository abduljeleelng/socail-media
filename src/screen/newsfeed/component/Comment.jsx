  ...
  deleteConfirmed = comment => {
    ...
    render() {
        ...
        return (
          ...
          <input type="text" value={text} onChange={this.handleChange('text')} className="form-control rounded" />
          <div className="comment-attagement d-flex">
            {
              loading ? ("<P> loading ... </P>")  : <button onChange={this.handleSubmit}> Comment..</button>
            }
          </div>
        </form>
        )
