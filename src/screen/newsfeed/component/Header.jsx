        ...
        <nav className="navbar navbar-expand-lg navbar-light p-0">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto navbar-list">
              <li>
                <Link to="/timeline" className="iq-waves-effect d-flex align-items-center">
                  <img src={logo} className="img-fluid rounded-circle mr-3" alt="user" />
                  <div className="caption">
                    <h6 className="mb-0 line-height"> {user.firstName} </h6>
                  </div>
                </Link>
              </li>
                ...
                <div className="iq-sub-dropdown iq-user-dropdown">
                  <div className="iq-card shadow-none m-0">
                    <div className="iq-card-body p-0 ">
                      ...
                      <a href className="iq-sub-card iq-bg-info-hover">
                        <div className="media align-items-center">
                      ...
                      <div className="d-inline-block w-100 text-center p-3">
                        <a className="bg-primary iq-sign-btn" href role="button">Sign out<i className="ri-login-box-line ml-2" /></a>
                      </div>
                    </div>
                  </div>
                </div>
